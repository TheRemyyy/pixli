...
- **Linux desktop support** — Explicit X11/Wayland winit features, Linux app id / WM_CLASS metadata, Vulkan + GL backend selection, and surface-capability based present mode fallback for GNOME, KDE Plasma, wlroots, X11, and XWayland sessions.
